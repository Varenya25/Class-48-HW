...
function setup(){
  ...
  swal({
    title: `Story!${"\n"}`,
    text: "Once there was writer and he wrote horror stories which would come to life if the book opens, so for this reason he kept all of his books locked, he wrote them with a magical typewriter, so one day, one of the the book gets opened. Then all the monsters come out of the book and haunt everyone, so If this has to stop then the monsters should go back in the book, so the magical book must go in search for the enchanted typewriter for an alternate ending so that all the monsters go back....   How to play : Press the space key to jump over the obstacles and if you touch it, the game is over and you have to press the reset button to restart, whenever you cross a 100 score you cross a checkpoint. Enjoy!",
